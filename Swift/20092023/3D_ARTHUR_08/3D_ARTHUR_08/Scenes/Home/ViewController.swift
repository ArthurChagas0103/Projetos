/*
    Normal: Arthur Gomes Chagas
    PascalCase: ArthurGomesChagas
    CamelCase: arthurGomesChagas
*/
...
class ViewController: UIViewController {
    ...
    private func loadList() {
        ...
        do {
            ...
            debugPrint("==> Erro ao recuperar dados na base CoreData")
        }
    }
...
extension ViewController: PokemonProtocol {
    ...
    func delete(pokemon: NSManagedObject) {
        ...
        do {
            ...
            debugPrint("==> Erro ao tentar excluir o pokemon")
        }
        self.reloadAll()
    }
